...
class _EditeResultState extends State<EditeResult> {
  ...
  final TextEditingController _garde = TextEditingController();
                    ...
                    Form(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          CustomTextField(
                              labelName: "Index Number", controller: _indexNumber),
                          const SizedBox(
                            height: 10,
                          ),
                          CustomTextField(
                              labelName: "Year", controller: _year),
                          const SizedBox(
                            height: 10,
                          ),
                          CustomTextField(
